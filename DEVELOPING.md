...
docker run -p 8000:8000 -it --rm -v $(pwd):/app -v sphinx_node_modules:/app/node_modules sphinx-rijkshuisstijl-2008
```

## With uv

For the sphinx theme development, make sure you have
